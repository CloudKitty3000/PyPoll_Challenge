...
path = r"C:\Users\cathe\OneDrive\Desktop\Classwork\Analysis Projects\PyPoll Challenge"
# Add a variable to load a file from a path.
#file_to_load = os.path.join("C:\Users\cathe\OneDrive\Desktop\Classwork\Analysis Projects\PyPoll Challenge\Resources\election_results.csv")
# Add a variable to save the file to a path.
#file_to_save = os.path.join("C:\Users\cathe\OneDrive\Desktop\Classwork\Analysis Projects\PyPoll Challenge\Analysis", "election_analysis.txt")

pypoll_csv = os.path.join(path, "Resources", 'election_results.csv')
